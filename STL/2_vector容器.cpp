...
int main() {
	...
	//程序直接崩掉，reserve是预留空间，元素还有没有添加，此时vec1.size() == 0,不能够[]根据下表随机访问哦
	//vector<int> vec1;
	//vec1.reserve(20);
	//vec1[0] = 111110;
	//vec1[5] = 5;
