...
类和类之间的关系：
组合：a part of... ...一部分的关系
继承：a kind of... ...一种的关系,如student是people的一种，people基类，student派生类
...
protected:
	int mb;
private:
	int mc; // 自己或者friend友元能访问私有的成员
};
//继承 A 基类/父类   B 派生类/子类
struct B : A    //struct默认public继承
{
public:
	void func()
	{
...
int main()
{
	//外部只能访问类得public成员，不能访问protected和private成员
	B b;
